...
export default function Navbar({ children }) {
  return (
    <>
      <Disclosure as="nav" className="bg-white-300 shadow-lg shadow-gray-200">
        {({ open }) => (
          <>
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                  <div className="flex flex-shrink-0 items-center  h-12 w-12">
                    <img
                      ...
                      src="https://github.com/jitujiten/ecommerceBackend/assets/120164938/5446ab69-97bf-4cd0-8d2a-cc17f00e48a1"
                      alt="Your Company"
                    />
                  </div>
                      ...
                      {navigation.map((item) => (
                        <a
                          ...
                          className={classNames(
                            ...
                            "agbalumo rounded-md px-3 py-2 text-md font-medium"
                          )}
