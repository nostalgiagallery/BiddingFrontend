...
const Footer = () => {
  return (
    <div className=" bg-[#2b3342]  max-w-full overflow-hidden  relative z-10  pt-16 md:pt-20 lg:pt-24 ">
      <div className="">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16  ml-10 md:ml-0">
              ...
              <div className="flex justify-center items-center">
                <a
                  ...
                  className=" mr-6 text-gray-500 duration-300 hover:text-indigo-500"
                >
                  <svg
                    width="9"
                    height="18"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-12 lg:mb-16">
              <h2 className="agbalumo mb-10 text-xl  text-white">
                Useful Links
              </h2>
              <ul>
                <li>
                  <a
                    href="/"
                    className="text-gray-300 mb-4 inline-block text-base text-body-color duration-300 hover:text-indigo-500"
                  >
                    Blog
                  </a>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-12 lg:mb-16">
              <h2 className="agbalumo mb-10 text-xl  text-white ">Terms</h2>
              <ul>
                <li>
                  <a
                    href="/"
        ...
        <div className="py-8">
          <p className="agbalumo text-center text-base text-gray-200">
            Template by Nostalgia Gallery (NG)
          </p>
        </div>
      </div>
