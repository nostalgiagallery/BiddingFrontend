              ...
              <div className="w-full px-4">
                <div className=" mx-auto max-w-[800px] text-center">
                  ...
                  <p className="text-gray-200 mb-12 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                    ...
                    <br />
                    "Let's fill your home with countless memories of your
                    beloved star, making it a place full of joy and nostalgia."
                  </p>
          ...
          <div className="container">
            <div className={`w-full mx-auto text-center`}>
              ...
              <h1 className="agbalumo text-gray-200 text-body-color md:text-lg p-4">
                ...
                player by providing you with the special items they used in
                their most memorable moments. Own a piece of their history and
                feel closer to their journey to greatness."
              </h1>
            </div>
            <div className="mx-4 flex flex-wrap ">
              <div className="w-full px-4 ">
                <div className=" mx-auto max-w-[770px] overflow-hidden rounded-md">
                  <div className="relative aspect-[77/40] items-center justify-center">
                    <img
                      src="https://github.com/jitujiten/ecommerceBackend/assets/120164938/4fd27696-f4f0-45f7-a710-1297e369e156"
                      alt="video image"
                    />
                  </div>
                </div>
